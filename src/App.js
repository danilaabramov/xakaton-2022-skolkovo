            ...
            <header>
                <section className="header">
                    <div className="container">
                        <svg width="60" height="35" viewBox="0 0 60 35" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginLeft: 140, marginTop: 15, position: 'relative', left: '-50%'}}>
                            <path d="M0.359375 35V0.453125H6.07812V35H0.359375ZM11.75 18.2188L23.75 35H17.2344L8 21.4062V14.5625L16.3906 0.453125H22.8125L11.75 18.2188ZM31.8125 0.453125H37.4375V35H31.8125V0.453125ZM42.2188 0.453125C45.125 0.453125 47.6719 0.921875 49.8594 1.85938C52.0781 2.76562 53.9062 3.98438 55.3438 5.51562C56.8125 7.04688 57.9062 8.79688 58.625 10.7656C59.3438 12.7031 59.7031 14.7031 59.7031 16.7656C59.7031 19.6094 59.3906 22.0469 58.7656 24.0781C58.1719 26.0781 57.4062 27.7656 56.4688 29.1406C55.5312 30.4844 54.4688 31.5469 53.2812 32.3281C52.125 33.1094 51 33.7031 49.9062 34.1094C48.8125 34.4844 47.8125 34.7344 46.9062 34.8594C46 34.9531 45.3281 35 44.8906 35H39.3594V30.875H43.0156C46.8281 30.875 49.5781 29.6562 51.2656 27.2188C52.9531 24.7812 53.7969 21.25 53.7969 16.625C53.7969 15.1875 53.625 13.7656 53.2812 12.3594C52.9375 10.9531 52.2656 9.6875 51.2656 8.5625C50.2969 7.40625 48.9688 6.48438 47.2812 5.79688C45.5938 5.07812 43.4062 4.71875 40.7188 4.71875H39.3594V0.453125H42.2188Z" fill="white"/>
                        </svg>
                    </div>
                </section>
            </header>
    ...
    return (
        <div>
            <header>
                <section className="header">
                    <div className="container">
                        <svg width="60" height="35" viewBox="0 0 60 35" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginLeft: 40, marginTop: 15}}>
                            <path d="M0.359375 35V0.453125H6.07812V35H0.359375ZM11.75 18.2188L23.75 35H17.2344L8 21.4062V14.5625L16.3906 0.453125H22.8125L11.75 18.2188ZM31.8125 0.453125H37.4375V35H31.8125V0.453125ZM42.2188 0.453125C45.125 0.453125 47.6719 0.921875 49.8594 1.85938C52.0781 2.76562 53.9062 3.98438 55.3438 5.51562C56.8125 7.04688 57.9062 8.79688 58.625 10.7656C59.3438 12.7031 59.7031 14.7031 59.7031 16.7656C59.7031 19.6094 59.3906 22.0469 58.7656 24.0781C58.1719 26.0781 57.4062 27.7656 56.4688 29.1406C55.5312 30.4844 54.4688 31.5469 53.2812 32.3281C52.125 33.1094 51 33.7031 49.9062 34.1094C48.8125 34.4844 47.8125 34.7344 46.9062 34.8594C46 34.9531 45.3281 35 44.8906 35H39.3594V30.875H43.0156C46.8281 30.875 49.5781 29.6562 51.2656 27.2188C52.9531 24.7812 53.7969 21.25 53.7969 16.625C53.7969 15.1875 53.625 13.7656 53.2812 12.3594C52.9375 10.9531 52.2656 9.6875 51.2656 8.5625C50.2969 7.40625 48.9688 6.48438 47.2812 5.79688C45.5938 5.07812 43.4062 4.71875 40.7188 4.71875H39.3594V0.453125H42.2188Z" fill="white"/>
                        </svg>
                    </div>
                </section>
