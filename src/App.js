                ...
                <div className="container">
                    <div className="video">
                        <div className="video__left_panel">
                            ...
                            <button className="video__left_panel__sound">
                        ...
                        <div className="video__center">
                            <div className="video__show">
                                <video className="video__show__clip" ref={vid} id="my-video" width="640" height="360">
                        ...
                        <div className="video__right_panel">
                            ...
                            <button className="video__right_panel__sound">
                            ...
                            <button className="video__right_panel__cut">
                                <svg width="23" height="23" viewBox="0 0 23 23" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <button className="video__right_panel__delete">
                                <svg width="23" height="23" viewBox="0 0 23 23" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <div className="text-editor__block__font">
                                    ...
                                    <form>
                                        <div className="__select" data-state="">
                                            <div className="__select__title" data-default="Open Sans">Open Sans</div>
                                        ...
                                        <form>
                                            <div className="__select2" data-state="">
                                                ...
                                                <div className="__select__content2">
                                                    <input id="singleSelect0" className="__select__input2" type="radio"
                                                           name="singleSelect" checked/>
                                                    <label htmlFor="singleSelect0"
                                                           className="__select__label2">14</label>
                                                    <input id="singleSelect1" className="__select__input2" type="radio"
                                                           name="singleSelect"/>
                                                    <label htmlFor="singleSelect1"
                                                           className="__select__label2">18</label>
                                                    <input id="singleSelect3" className="__select__input2" type="radio"
                                                           name="singleSelect"/>
                                                    <label htmlFor="singleSelect3"
                                                           className="__select__label2">24</label>
                                                    <input id="singleSelect4" className="__select__input2" type="radio"
                                                           name="singleSelect"/>
                        ...
                        <div className="save">
                            ...
                            <div className="save__format" style={{display: formatBlock ? '' : 'none'}}>
                                ...
                                <ul className="save__format__list">
                                    ...
                                    <li data-path="AVI" className="save__format__list__elem">AVI</li>
                                    <li data-path="MKV" className="save__format__list__elem">MKV</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div id="scroller" style={{
                    ...
                    <div style={{width: 0, display: 'flex'}}>
                        <img id="end3" src={require('./end.png')}
                             style={{height: 9, left: screens.length * 147 - 11, top: 9.5, position: "relative"}}></img>
                    </div>
                    <div style={{width: 0, display: 'flex'}}>
